...
export const getProfiles = async (req, res) => {
  try {
    ...
    sendResponse(res, 500, false, 'Failed to retrieve profiles')
  }
}
...
export const getProfileById = async (req, res) => {
  try {
    ...
    sendResponse(res, 500, false, 'Failed to retrieve profile')
  }
...
export const createProfile = async (req, res) => {
  try {
    ...
    sendResponse(res, 500, false, 'Failed to create profile')
  }
}
...
export const deleteProfile = async (req, res) => {
  try {
    ...
    sendResponse(res, 500, false, 'Failed to delete profile')
  }
}
